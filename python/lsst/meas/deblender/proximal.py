...
class ExposureDeblend:
    ...
    def deblendParent(self, parentIdx=0, condition=None, initPsf=False, display=True,
                      displaySeds=True, displayTemplates=True, imgLimits=True,
        ...
        deblend.deblend(constraints=constraints)